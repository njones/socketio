...
func TestPacketV1Read(ext *testing.T) {
	type want struct {
		data [][]byte
		n    int64
		err  error
	...
	var tests = []struct {
		...
		{
			name: "CONNECT",
			pac:  PacketV1{packet: packet{Type: ConnectPacket, Namespace: packetNS("/")}},
			want: want{
				data: [][]byte{[]byte(`0`)},
				n:    1,
				err:  nil,
		...
		},
		{
			...
			pac:  PacketV1{packet: packet{Type: EventPacket, Namespace: packetNS("/admin"), Data: &packetDataArray{skipBinary: true, x: []interface{}{"project:delete", 123.0}}, AckID: 456}},
			want: want{
		...
		{
			name: "ACK",
			pac:  PacketV1{packet: packet{Type: AckPacket, Namespace: packetNS("/admin"), Data: &packetDataArray{skipBinary: true}, AckID: 456}},
			want: want{
		...
		{
			name: "ERROR",
			pac:  PacketV1{packet: packet{Type: ErrorPacket, Namespace: packetNS("/admin"), Data: &packetDataString{&noAuth}}},
			want: want{
		...
		},
		{
			...
			pac:  PacketV1{packet: packet{Type: ConnectPacket, Namespace: packetNS("/admin?token=1234&uid=abcd")}},
			want: want{
...
func TestPacketV1Write(ext *testing.T) {
	type want struct {
		pac PacketV1
		n   int
		err error
	...
	var tests = []struct {
		...
		},
		{
			...
			data: [][]byte{[]byte(`3/admin,456[]`)},
			want: want{
				pac: PacketV1{packet: packet{Type: AckPacket, Namespace: packetNS("/admin"), Data: &packetDataArray{skipBinary: true, x: []interface{}{}}, AckID: 456}},
				n:   13,
				err: nil,
			},
		},
